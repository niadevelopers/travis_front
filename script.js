...
function updateRuleSuggestion() {
    ...
    const dailyLiving = remaining * 0.5;
    const setAside = remaining * 0.3;
    const justInCase = remaining * 0.2;
