...
function showTxModal() {
    ...
    const modal = document[_0x444f3e(0x1f6)](_0x444f3e(0x2ec));
    if (!modal) return;
    
    // Clear and populate fields (existing code)
    const _0x41731d = document['getElementById'](_0x444f3e(0x1ba));
    const _0x57f376 = document['getElementById'](_0x444f3e(0x32d));
    // ... rest of your existing code ...
    
    // Show the modal properly
    modal[_0x444f3e(0x25f)]['add'](_0x444f3e(0x311));
    modal[_0x444f3e(0x2cd)][_0x444f3e(0x31d)] = 'flex'; // Ensure it's visible
    updateLiveHud();
}
...
function closeTxModal() {
    ...
    const modal = document[_0x2d2dde(0x1f6)](_0x2d2dde(0x2ec));
    if (modal) {
        modal[_0x2d2dde(0x25f)]['remove'](_0x2d2dde(0x311));
        // Also ensure the backdrop/overlay is hidden
        modal[_0x2d2dde(0x2cd)][_0x2d2dde(0x31d)] = 'none';
    }
    // Clear the amount field
    const amountInput = document[_0x2d2dde(0x1f6)](_0x2d2dde(0x3de));
    if (amountInput) {
        amountInput[_0x2d2dde(0x27f)] = '';
    }
}
